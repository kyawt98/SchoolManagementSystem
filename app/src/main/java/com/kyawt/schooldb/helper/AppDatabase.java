...
@Database(entities = {CourseModel.class, SubjectModel.class, ParentModel.class, RegisterModel.class, TeacherModel.class, StudentModel.class}, version = 8, exportSchema = false)
